# Threat model — AtleyOS Mobile

## Assets

- Owner Profile Knowledge / Memory on the home host  
- Device API tokens and WireGuard keys on the phone  
...
| Phone app + OS Keystore | Trusted for device secrets |
...
| Stolen phone | Biometric unlock; revoke drops WG peer + tokens; SecureStore |
...
| App vulnerability | Blast radius = that device’s keys after revoke |
